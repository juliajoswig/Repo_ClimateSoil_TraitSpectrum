Figure_S1 <- function(){
  ...
  # get some functions
  list.files(file.path(origin,"scripts",version_now,"02_figure_functions"))
  source(file.path(origin,"scripts",version_now ,"_master","fn_functions.R"))
  source(file.path(origin,"scripts",version_now,"02_figure_functions","fig_extended_data","project_raster.R"))
