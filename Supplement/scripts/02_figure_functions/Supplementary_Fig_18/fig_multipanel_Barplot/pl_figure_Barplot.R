...
#  plot(all_effects_tot[1,],all_effects_tot[3,]) 
  ...
  if(!file.exists(file.path(origin,"figures","Supplement_Fig_18_33","Barplot"))){
    dir.create(file.path(origin,"figures","Supplement_Fig_18_33","Barplot"))
  }
  ...
  for(trait_now in 1:17){
    ...
    pdf(file = file.path(origin,"figures","Supplement_Fig_18_33","Barplot",paste0(colnames(all_effects_soil)[trait_now],"_Barplot.pdf")),
