...
#  plot(all_effects_tot[1,],all_effects_tot[3,]) 
  ...
  if(!file.exists(file.path(origin,"figures","figure_S_Multipanel","Barplot"))){
    dir.create(file.path(origin,"figures","figure_S_Multipanel","Barplot"))
  }
  ...
  for(trait_now in 1:17){
    ...
    pdf(file = file.path(origin,"figures","figure_S_Multipanel","Barplot",paste0(colnames(all_effects_soil)[trait_now],"_Barplot.pdf")),
