plot_Figure_x <- function(origin,output_term){
  ...
  #----------------------------------------------------------------------------
  if(!dir.exists(file.path(origin,"figures","figure_S_DipBiome"))){
    dir.create(file.path(origin,"figures","figure_S_DipBiome"))}
  
  pdf(file=file.path(origin,"figures","figure_S_DipBiome","Figure_S_Dip29to36PrecSand.pdf"),width = 10,height = 10)
