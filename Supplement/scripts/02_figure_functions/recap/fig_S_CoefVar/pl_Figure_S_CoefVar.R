pl_CoefVar <- functio(origin){
  ...
  pdf(file=file.path(origin,"figures","figure_S_CoefAggreg","Figure_S_CoefAg_sd_gf.pdf"))
...
pdf(file=file.path(origin,"figures","figure_S_CoefAggreg","Figure_S_CoefAg_sd_obs.pdf"))
  ord.ix <- match(target_order1,trait_names)
...
pdf(file=file.path(origin,"figures","Revision_Ian","Coefficient_of_Variation_VS_r2_v2obs.pdf"),width = 8,height = 6)
