...
pl_NOselComparison <- function(){
  ...
  if(!dir.exists(file.path(origin,"figures","figure_S_SelAggComparison"))){
    dir.create(file.path(origin,"figures","figure_S_SelAggComparison"))}
  

  pdf(file=file.path(origin,"figures","figure_S_SelAggComparison",paste0("figure_S_SelAggComparison.pdf")),height=7,width=5)
