soil <- TRY_Env$soil
tab_S_TraitInfo <- function(origin,soil){
...
#-----
  ...
  if(!file.exists(file.path(origin, "tables","Table_S_SoilInfo"))){
    dir.create(file.path(origin, "tables","Table_S_SoilInfo"))}
  
  write.csv(res, file=file.path(origin, "tables","Table_S_SoilInfo","Tab_S_SoilInfo.csv"))
#  print(xtable(res, type = "latex"), file =file.path(origin, "tables","Table_S_SoilInfo","Tab_S_SoilInfo.tex"))
#  print(xtable(res, type = "latex"),include.rownames=FALSE)
  ...
  print(xtable(Table_S4, type = "latex"), file =file.path(origin,"tables","Table_S_SoilInfo","Tab_S_SoilInfo.tex"))
  return(res)
}
