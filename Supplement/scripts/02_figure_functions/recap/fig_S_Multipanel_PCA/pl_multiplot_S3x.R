...
#-----------------------------------------------------
  ...
  if(!file.exists(file.path(origin,"figures","figure_S_singleTraitMultipanels"))){
    file.create(file.path(origin,"figures","figure_S_singleTraitMultipanels"))}
  ...
  pdf(file = file.path(origin,"figures","figure_S4",paste0(colnames(trait)[trait_now],"_Correl.pdf")),width=13,height=5)
  ...
  png(file = file.path(origin,"figures","figure_S4",paste0(colnames(trait)[trait_now],"_Correl.png")),width=2200,height=1100,res=300)
  par(mfrow=c(3,8),mar=c(0,0,0,0))
  n=0
  for(i in 1:length(plot_data)){
    val_now = plot_data[i]
