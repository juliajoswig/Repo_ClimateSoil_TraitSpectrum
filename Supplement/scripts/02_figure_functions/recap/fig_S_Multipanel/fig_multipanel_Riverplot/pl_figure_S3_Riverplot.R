plot_figure_S4_Riverplot <- function(origin){
  ...
  if(!file.exists(file.path(origin,"figures","figure_S_Multipanel","Riverplot"))){
    dir.create(file.path(origin,"figures","figure_S_Multipanel","Riverplot"))
  }
...
#  plot(1:19,col=rgb(.77, .177, .244),cex=4,pch=16)
  ...
  save(RPE_l,file=file.path(origin,"figures","figure_S_Multipanel","Riverplot",paste0("Riverplot_info.RData")))

  # load riverplot
  load(file.path(origin,"figures","figure_S_Multipanel","Riverplot",paste0("Riverplot_info.RData")))
