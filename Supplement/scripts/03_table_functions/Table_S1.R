...
tab_S_TraitInfo <- function(origin,climate){
  ...
  if(!file.exists(file.path(origin, "tables","Table_S_ClimateInfo"))){
    dir.create(file.path(origin, "tables","Table_S_ClimateInfo"))}
  
  write.csv(res, file=file.path(origin, "tables","Table_S_ClimateInfo","Tab_S_ClimateInfo.csv"))
  print(xtable(res, type = "latex"), file =file.path(origin, "tables","Table_S_ClimateInfo","Tab_S_ClimateInfo.tex"))
